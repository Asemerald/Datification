...
namespace Utils
{
    public class BaseNetworkSingleton<T> : NetworkBehaviour where T : NetworkBehaviour
    {
#if UNITY_EDITOR
                ...
                if (_instance == null)
                {
                    ...
                    else
                    {
                        ...
                        if (SHOW_DEBUG)
                        {
                            ...
                            {
                                Debug.Log($"Successfully created a network singleton for the {typeof(T)} class.");
                            }
                        }
#endif
                    }
